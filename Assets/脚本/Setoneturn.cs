...
public class Setoneturn : MonoBehaviour
{
    public string targetSceneName1 = "StartMenu";
    public string targetSceneName2 = "SetMenu2";
    public string targetSceneName3 = "GameScene2";
    ...
    {
        ShowShipColorSelection(targetSceneName3);
    }
